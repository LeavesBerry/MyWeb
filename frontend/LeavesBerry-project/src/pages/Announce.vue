	...
	<teleport class="fixed-page" to="#app #app">
		...
		<div class="hidden-container" :style="configModule.hiddenContentStyle">
			<div class="content-container" :style="configModule.containerStyle">
				<button class="hide-content-button" 
...
<script setup>
	...
	async function expandAnno(id, title) {
		const res = await axiosRequest.getAnnoText(id);
		configModule.expandContent(title, res.main_text)
